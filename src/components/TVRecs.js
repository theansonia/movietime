  ...
  return ( 
    <div id='recs'  >
        ...
        <Link style={{ textDecoration: 'none' }} to={`/details/${name}`} >
            {pic !== 'https://image.tmdb.org/t/p/w500/null' ? <img style={{borderRadius: '30px'}} id='recposter' src={pic} alt={`Movie poster for ${name}`} /> : <img id='recposter' src='https://image.tmdb.org/t/p/w500//8SRUfRUi6x4O68n0VCbDNRa6iGL.jpg' alt='back up movie poster cinema pardiso' /> }
        </Link>
