...
function App() {
  ...
  return (
      ...
      <div id='app'>
        ...
        <Link to='/home' id="homebutton"><div data-testid='homebtn' onClick={() =>{updateSearchStatus(false); updateCategory(null)}}>
          <svg id='homebtn'  width="48" height="48" viewBox="0 0 24 24" fill="" xmlns="http://www.w3.org/2000/svg">
        ...
        {category === null ? 
        <Link to={'/home'}>
        <div onClick={() => {updateSearchStatus(true)}} >
        ...
        <Switch>
          <Route path='/movies' >
            <Search category={category} updateCategory={updateCategory} searchStatus={searchStatus} /> 
          </Route>
          <Route path='/shows' >
            <TvSearch category={category} updateCategory={updateCategory} searchStatus={searchStatus} /> 
          </Route>
          <Route path='/home' >
            <TrendingSearch category={category} updateCategory={updateCategory} searchStatus={searchStatus} /> 
          </Route>
