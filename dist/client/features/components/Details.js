...
const TVRecs_1 = __importDefault(require("./TVRecs"));
...
const TVDetails = (props) => {
    ...
    return (jsx_runtime_1.jsx("div", Object.assign({ className: theme }, { children: jsx_runtime_1.jsx("div", Object.assign({ id: 'morelikethis' }, { children: !details ? null : (jsx_runtime_1.jsxs("div", Object.assign({ id: 'detail' }, { children: [jsx_runtime_1.jsx("div", Object.assign({ id: 'detailposter' }, { children: `https://image.tmdb.org/t/p/w500/${details.poster_path}` !==
                            'https://image.tmdb.org/t/p/w500/null' ||
                            `https://image.tmdb.org/t/p/w500/${details.poster_path}` !==
                                'https://image.tmdb.org/t/p/w500/undefined' ? (jsx_runtime_1.jsx("img", { id: 'detailposter', src: `https://image.tmdb.org/t/p/w500/${details.poster_path}`, alt: `Movie poster for ${name}` }, void 0)) : (jsx_runtime_1.jsx("img", { id: 'poster', src: 'https://image.tmdb.org/t/p/w500//8SRUfRUi6x4O68n0VCbDNRa6iGL.jpg', alt: 'back up movie poster cinema pardiso' }, void 0)) }), void 0), jsx_runtime_1.jsxs("div", Object.assign({ id: 'detaildetails' }, { children: [details.name ? jsx_runtime_1.jsx("div", Object.assign({ id: 'detailtitle' }, { children: details.name }), void 0) : null, details.first_air_date ? (jsx_runtime_1.jsx("div", Object.assign({ id: 'detailrelease' }, { children: `${details.first_air_date.split('-')[0]}` }), void 0)) : null, details.overview ? (jsx_runtime_1.jsx("div", Object.assign({ id: 'detailoverview' }, { children: details.overview }), void 0)) : null, Math.round(details.vote_average / 2) ? (jsx_runtime_1.jsx("div", Object.assign({ id: 'detailrating' }, { children: Math.round(details.vote_average / 2) ? (jsx_runtime_1.jsx(Stars_1.default, { rating: Math.round(details.vote_average / 2), reviews: details.vote_count }, void 0)) : ('No Rating') }), void 0)) : null, !watch ? null : (jsx_runtime_1.jsx("a", Object.assign({ id: 'providers', rel: 'noreferrer', href: `${watch.link}`, target: '_blank' }, { children: "Where to Watch" }), void 0)), providers ? (jsx_runtime_1.jsx("div", Object.assign({ id: 'logos' }, { children: providers.map((logo, i) => {
                                    return (jsx_runtime_1.jsx("a", Object.assign({ href: logo[1], rel: 'noreferrer', target: '_blank' }, { children: jsx_runtime_1.jsx("div", Object.assign({ id: 'shinediv' }, { children: jsx_runtime_1.jsx("img", { id: 'logo', src: `https://image.tmdb.org/t/p/w500/${logo[0]}`, alt: 'thumbnail for current provider' }, `logoid - ${logo.toString()} + ${i} `) }), void 0) }), `${logo.toString()} + ${i}`));
                                }) }), void 0)) : null] }), void 0), recommendations ? (jsx_runtime_1.jsx("div", { children: recommendations.map((rec, i) => {
                            jsx_runtime_1.jsx("div", Object.assign({ id: 'likethis' }, { children: "More Like This" }), void 0);
                            if (i < 5)
                                return (jsx_runtime_1.jsx(TVRecs_1.default, { name: rec.title || rec.name, pic: `https://image.tmdb.org/t/p/w500/${rec.backdrop_path}` }, rec.id));
                        }) }, void 0)) : (jsx_runtime_1.jsx("div", Object.assign({ id: 'likethis' }, { children: "No recommendations available" }), void 0))] }), void 0)) }), void 0) }), void 0));
};
exports.default = TVDetails;
